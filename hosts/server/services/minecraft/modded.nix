    ...
    symlinks = {
          ...
          "plugins/FreedomChat.jar" = pkgs.fetchurl {
            ...
            "mods/Incendium.jar" = pkgs.fetchurl {
                    url = "https://cdn.modrinth.com/data/ZVzW5oNS/versions/vPwuqZ5y/Incendium_26.2_v5.5.1.jar";
            ...
            "mods/YungsBetterNetherFortresses" = pkgs.fetchurl {
                    url = "https://cdn.modrinth.com/data/Z2mXHnxP/versions/XJWhXWgn/YungsBetterNetherFortresses-26.1.2-NeoForge-4.1.0.jar";
